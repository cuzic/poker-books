...
必要勝率 = コール額 ÷ 最終ポット
  2bb → 22%  2.5bb → 27%  3bb → 31%  4bb → 35%  6bb → 40%  8bb → 42%
...
・大きいオープン (5bb+): T_call += (サイズ−2.5)×2 で引き締め。バリュー3ベットのみ、ブラフ3ベット禁止
...
10. ISO レイズ (前にリンプがいる場合): サイズ = 3BB + 1BB×リンパー数 / T_iso: IP+1人=T_open−2、IP+2人以上・OOP=T_open
