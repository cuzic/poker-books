...
ポーカーの世界チャンピオン、ダニエル・ネグラヌ（Daniel Negreanu）はMasterClass（ポーカー講座）の中で、繰り返しの練習によって計算が自動化し、やがて呼吸するような自然な直感になると語っています。
...
- ポジション → **しきい値の違い**（UTG 24 / HJ 22 / CO 20 / BTN 18 / SB 22）
- スタック深度 → **しきい値の調整（第14章）**
