...
役スコア: セット85 / 2ペア75 / TPTK65 / オーバーペア(AA-QQ=80/JJ-TT=75/99-=70) / etc.
ドローボーナス: ナッツFD+33 / 非ナッツFD+30 / OESD+24 / BDFD+6(フロップのみ) / ガットショット+12
2OCボーナス: +24
```
...
```
mono (B=70): 75%
2tone (B=50/56) / rainbow_connected (B=67, top≥J) / paired (B=71/83): 50%
dry rainbow (B ≤ 62): 33%
```
