...
wide range (CBS 3 以上の strong も mid も含む) で打てるため、ブラフのコストも低く抑えられます。
...
サイズを決めた後、Light UCBS v2 の 25 セル表で freq を確認します。
...
- CBS バンド mid (5-6) は 33% 推奨。high bet は strong / nut 限定。
