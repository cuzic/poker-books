...
df["pred"] = df.apply(predict_v25, axis=1)
...
V24_LOSS = 27.0125; V24_AQS = 84.35
print(f"v25: acc={acc:.3f}%  avg_loss={avg_loss:.4f}%  AQS={score:.2f}")
print(f"vs v24: avg_loss {V24_LOSS:.4f}% -> {avg_loss:.4f}% ({avg_loss-V24_LOSS:+.4f}pp)  AQS {V24_AQS} -> {score:.2f} ({score-V24_AQS:+.2f})")
