...
DIR = Path("/home/cuzic/poker-books/knowledges/gto_wizard_study/probe_edge_boundaries_v2")
OUT = Path("/home/cuzic/poker-books/knowledges/gto_wizard_study/EDGE_BOUNDARIES_V2_ANALYSIS.md")
...
CAT_NAMES = {
    ...
    "ov_2over": "1b. overpair 格下げ境界 (2/3 overcards)",
    "aa_wet": "2b. AA on wet/monotone board",
    "low_sizing": "3. low overpair の sizing 境界",
    "attk": "4. BTN attacker 側",
    "river_catch": "5. river bluff catch 境界",
    "jj_cross": "6. JJ の board cross 比較",
    "3over": "7. 3 連 overcard",
    "tptk": "8. TPTK の格下げ",
