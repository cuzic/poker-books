...
df["pred"] = df.apply(predict_v23, axis=1)
...
print(f"v23: acc={acc:.3f}%  avg_loss={avg_loss:.4f}%  AQS={score:.2f}")
print(f"vs v22: avg_loss {28.4021:.4f}% -> {avg_loss:.4f}% ({avg_loss-28.4021:+.4f}pp)  AQS 79.25 -> {score:.2f} ({score-79.25:+.2f})")
