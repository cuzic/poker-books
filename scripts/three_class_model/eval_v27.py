    ...
    if street == "flop":
        if pos == "OOP":
            ...
            if pot == "4BP":
                ...
                if tier == "エア":
                    if is_ace_high: return "BET"      # ace_high 55.9%
                    return "CHECK"                    # king_high 35.1%, no_made 35.6%
        ...
        if pos == "IP":
            ...
            if pot == "3BP":
                ...
                if tier == "アンダーペア":
                    if bt == "paired" and mv == "underpair": return "CHECK"  # v27: underpair 28.2%
            ...
            if pot == "3BP":
                ...
                if tier == "アンダーペア":
                    if bt == "wet" and is_low_pair: return "CHECK"  # v27: low_pair 18.7%
                    if bt == "wet": return "BET"
                    if bt == "paired" and has_none: return "BET" if (4 < tr2 < 10) else "CHECK"
                if tier == "エア":
                    if has_strong:
            ...
            if pot == "4BP":
                if tier == "TP+":
                    ...
                    if bt == "paired":
                        if has_gutshot: return "BET"
                        return "BET" if tr > 10 else "CHECK"
                    if bt == "dry" and mv == "overpair": return "CHECK"  # v27: overpair 34.7%
        ...
        if pos == "IP":
            ...
            if pot == "SRP":
                ...
                if tier == "エア":
                    if bt == "paired":
                        ...
                        # v27: ace_high×paired = 98.8% BET → BET (was incorrectly CHECK)
            ...
            if pot == "3BP":
                ...
                if tier == "2P+" and bt == "dry" and mv == "two_pair": return "CHECK"  # v27: two_pair 45.6%
            ...
            if pot == "4BP":
                ...
                if tier == "エア" and bt == "paired" and is_ace_high: return "BET"  # v27: ace_high 91.5%
...
df["pred"] = df.apply(predict_v27, axis=1)
...
V26_LOSS = 26.8800; V26_AQS = 84.83
print(f"v27: acc={acc:.3f}%  avg_loss={avg_loss:.4f}%  AQS={score:.2f}")
print(f"vs v26: avg_loss {V26_LOSS:.4f}% -> {avg_loss:.4f}% ({avg_loss-V26_LOSS:+.4f}pp)  AQS {V26_AQS} -> {score:.2f} ({score-V26_AQS:+.2f})")
