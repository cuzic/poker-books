...
df["pred"] = df.apply(predict_v31, axis=1)
...
V30_LOSS = 26.4825; V30_AQS = 86.29
print(f"v31: acc={acc:.3f}%  avg_loss={avg_loss:.4f}%  AQS={score:.2f}")
print(f"vs v30: avg_loss {V30_LOSS:.4f}% -> {avg_loss:.4f}% ({avg_loss-V30_LOSS:+.4f}pp)  AQS {V30_AQS} -> {score:.2f} ({score-V30_AQS:+.2f})")
