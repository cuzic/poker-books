        ...
        if pos == "IP":
            ...
            if pot == "SRP":
                ...
                if tier == "アンダーペア":
                    ...
                    # v39: dry second_pair tr=13 → CHECK (GTO=41.0%, K-high boards)
                    if bt == "dry" and is_second_pair: return "BET" if tr != 13 else "CHECK"
                if tier == "エア":
                    ...
                    if bt == "dry" and has_none:
                        ...
                        if is_king_high: return "BET" if tr <= 12 else "CHECK"
                        if is_ace_high: return "BET" if tr == 10 else "CHECK"
