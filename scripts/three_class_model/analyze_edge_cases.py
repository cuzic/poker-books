...
DIR = Path("/home/cuzic/poker-books/knowledges/gto_wizard_study/probe_edge_cases")
OUT = Path("/home/cuzic/poker-books/knowledges/gto_wizard_study/EDGE_CASES_ANALYSIS.md")
...
for cat in ["A_overestimate", "B_underestimate", "C_counterfeit", "D_pot_demote"]:
