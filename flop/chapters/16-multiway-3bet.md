...
**T♠9♠8♣（ウェット、A=1）、IP が50%（C=5）CBet**

| BBのハンド | HandScore | 後手スコア = HS+1−3−5 | 判定 |
|----------|----------|---------------------|------|
| KK（オーバーペア） | 20 | 20+1−3−5 = **13** | CR推奨（混合） |
| QJ（OESD） | 12 | 12+1−3−5 = **5** | コール |
| 44（アンダーペア） | 6 | 6+1−3−5 = **−1** | フォールド境界（3BP では BB レンジに含まれにくい）|
