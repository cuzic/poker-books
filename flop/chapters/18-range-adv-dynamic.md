...
> **本章の目標**: 相手のフロップアクション（CBetサイズ・チェック）から、相手のHandScore帯を大まかに読む感覚を身につけます。精密なベイズ更新は巻③ 第7章で扱います。
...
|-----------|----------------|------------|
| 75%+ | H3（≥ 14）中心 | ポラライズ（強いバリュー or ブラフ）|
| 33% | H2（7〜13）中心 | リニア（レンジ全体でベット）|
...
- 主に **H1（HandScore ≤ 6）**：ブランク空振り・弱いドロー
...
| 相手のCBet後の自分の状況 | 推奨方針 |
|----------------------|--------|
| 自分がH3（≥ 14） | 後手スコアを計算 → コール or チェックレイズ |
| 自分がH2（7〜13） | MDFラインを基準にコールを検討 |
| 自分がH1（≤ 6） | 後手スコア < 0 → フォールド |

本章はその前段として「相手のHandScore帯を大まかに読む」だけに役割を絞ります。

---

> **巻③へのブリッジ**: 本章は「CBetサイズ→相手のHandScore帯」という入門的な逆読みです。より精密な「ベイズ更新による確率的レンジ絞り込み」は **巻③ 第7章「フロップアクションによる絞り込み」** で扱います。サイジング4区分（33%/50%/75%/OB）の精密解釈、連鎖的な多段更新（フロップ→ターン）はそちらへ進んでください。
