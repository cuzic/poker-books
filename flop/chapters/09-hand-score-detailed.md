...
> 🗺️ **現在地**:巻② / **[II 部 基礎・連続派]** / ch9「HandScore」（ハンド評価のコア ★★★）
...
フロップ時点で「すでに完成している役」を次のように点数化します。各値は GTO の bet 頻度と単調に対応するよう設定されています（強い役ほど高得点、bet されやすい）。
...
（b）K♣9♣：トップペア（K）、キッカー 9 は 8〜T 帯なので TPMK = **8点**

高い順：（c）30点 →（a）20点 →（b）8点。
