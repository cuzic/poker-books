...
- ドロー加点：OESD+FD = 13 effective アウツ × 4 = +52
- 役割：モンスタードロー（OESD＋ナッツFD、13 アウツ）→ **攻める**
...
OESDは8アウツ（ドロー加点 +32 = 8 × 4、Rule of 4 直接）で、空振り 8 と合わせて HandScore = 40 のセミブラフ候補に該当します。
...
**A2.** 正解は**2または3**です。
T♠5♣ は TPWK（弱キッカー、HS 45）で「捨てる手（中下端）」に分類されます。GTO 上もキッカー J 以下のトップペアは **bet 頻度わずか 9.6%** でほぼチェック扱いです。
