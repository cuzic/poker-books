...
ペアードフロップの簡易レンジスコアモデルは改訂版で **AA/KK/QQ を個別のパターン** に分離し、GTO実測値（AA-X≈100%、KK-X≈90%、QQ-X≈80%）に直接対応させています。
...
> **巻③ で深掘り**:本章は巻② 内のズレ要約。**全章横断の「GTO とのズレ統合マップ」**は巻③ 付録 H′′ にあり、4 源泉（離散化 / 単一決定 / モデル簡略 / シナリオ前提）× 13 章 × ズレ大小マトリクスで詳細整理されている。
