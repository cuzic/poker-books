...
HandScore = TPTK **70** + ブロッカーなし（ハート1枚もなし）= **70**。簡易レンジスコア頻度 = モノトーン = **70%**（高頻度・33%サイズ固定）。

モノトーンは小サイズで広いレンジをベットするのが GTO の正解（257ボード実測平均 70.5%）。**CBet 33%** が正解。
