...
| 3 | KTs | UTGオープン | 26.5 | オープン | 強バンド | オープン | オープン |
| 4 | QJs | UTGオープン | 27 | オープン | 強バンド | オープン | オープン |
| 5 | JTs | COオープン | 25 | オープン | 強バンド | オープン | オープン |
| 6 | T9s | BTNオープン | 23 | オープン | 強バンド | オープン | オープン |
| 7 | 98s | COオープン | 21 | オープン | 強バンド | オープン | オープン |
| 8 | 98s | MPオープン | 21 | フォールド | 混合ゾーン | オープン | フォールド |
...
UTGでA8s（スコア24）を持っています。R1とR2を適用した場合、手の左側カードのスートが♥のとき、どのように判断しますか。
...
スコア24は混合ゾーンに入ります。A（高い方のカード）のスートが♥なのでアクション側。**UTGからオープンします**。
...
COでK9s（スコア25）を持っています。R1でのバンドを判断し、R2が必要な場合は適用してください。手の左側カードのスートはK♦です。
...
スコア25は強バンドです。**スートに関わらずCOオープン確定**。K♦でもオープンです。
...
BBでK8s（スコア23）を持っています。BTNが2.5BBオープンしてきました。R3を含むBB防御判断（対BTN防御しきい値14）を行ってください。また対BTNのR=−2を適用した場合のスコアはいくつですか。
...
スコア21は3ベット候補（16以上）です。ただしK8sはブラフ3ベットとしての価値を確認する必要があります。Kのブロッカーがあるので3ベット候補として有効。**3ベット**が推奨です。
