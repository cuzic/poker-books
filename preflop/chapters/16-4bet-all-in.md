...
2. **GTO 整合**: KQs を例にとると Score_BB=37 ≥ T_5bet=39（不可ではないものの届かず）、通常 Score(KQs)=31 → どちらでも 5-bet しないが、KK を超える hand が 5-bet しないので意味は同じ
3. **シンプル化**: BB であっても 5-bet 帯（AA のみ純戦略 / KK は状況依存）はほかポジと同じルールで判断できる
