...
本書の「スーテッド +3」は、フラッシュドロー（11%）＋エクイティ向上（3〜5%）＋プレイアビリティを反映した値です。しかしブロッカー効果や3ベット耐性までは評価できていません。実際、A5sの本書スコアは14 + 5 + 3 − 1 = 21で、UTGしきい値24を下回ります。GTOはUTGでA5sを開く一方、本書はフォールドと判定します。
