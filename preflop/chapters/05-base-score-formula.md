...
<figure><img src="images/range-table-score-heatmap.png" alt="169ハンドのスコア値を濃淡で示すヒートマップ（AA=38〜72o=7）。しきい値ライン UTG≥24 / HJ≥22 / CO≥20 / BTN≥18 付き" /><figcaption>ハンドスコア ヒートマップ — 高スコア（緑）ほど多くのポジションでオープン可能。グラデーションバーの縦線がポジション別しきい値を示す</figcaption></figure>
