...
全ポジションでオープン。AA〜JJ、TT、AKsが30前後に並びます。
...
本書スコアは **Aのブロッカー効果**（相手のAAやAKが減る）を評価していません。GTOではAxsのブロッカー効果を高く評価し、3ベットブラフ候補としても活用します。

**補足ルール**：A2s〜A5sはスコアが低くても、中〜上級者はUTG〜COで採用を検討する価値があります。初心者のうちは「本書スコアに従って控えめに」で十分です。
...
- 77はUTGしきい値24にぴったり、境界の基準点である
- K3s=17、72o=7など弱いハンドははっきり低スコアになる
...
- **問2**：（1） KQs=28はUTGからすべてオープン可、(2) JTs=24はUTGからすべてオープン可、(3) 98s=20はCO以降でオープン可
