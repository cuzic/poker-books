...
本書のスコア式は、プレミアムハンドや明確な弱ハンドではGTOとよく整合します。しかし、**しきい値の近辺（±1点）**のハンドでは、式では拾えない要素（ブロッカー効果、Wheel可能性、ポストフロップのプレイアビリティなど）が効いて、**GTO との乖離**が生まれます。
...
**「BTNからは22+ すべてオープン」**と覚える。COからは44+、HJからは55+、UTGからは77+ と、ポジションごとにペア最低値が2ずつ上がる規則性があります。
