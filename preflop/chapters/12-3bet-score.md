...
対BTNしきい値18をわずかに超えるが、対CO20）・対UTG（23）では届きません。**3ベットには基本不適で、コール寄り**のハンドです。QJoは強そうに見えて、ブロッカー効果が弱く、3ベットした後に4ベット返しされると降ろされる悲しいハンドです。BTNオープンへの3ベットとしては成立しますが、対CO以上のオープンに対してはコールが無難です。
...
- しきい値：対UTG 23、対MP 21、対CO20-5節参照）
