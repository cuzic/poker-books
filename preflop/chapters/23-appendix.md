...
<figure><img src="images/range-table-score-heatmap.png" alt="169ハンドのスコアヒートマップ。高スコア（緑）ほど広いポジションでオープン可能。しきい値ライン UTG≥24 / HJ≥22 / CO≥20 / BTN≥18 付き" /><figcaption>付録B 補足：ハンドスコア ヒートマップ — 各セルに手名とスコアを表示。グラデーションバーの縦線がポジション別しきい値</figcaption></figure>
