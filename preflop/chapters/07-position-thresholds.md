...
プリフロップスコアでは AJo を UTG で開くと判定されます。A ブロッカー +3 を組み込んだことで UTG しきい値 24 を大きく上回ります。ただし GTO ツールによっては AJo の UTG オープンを混合戦略（約50〜80%頻度）とするものもあり、本章末の【GTOとのズレ】で扱います。
...
| ハンド | 本書 | GTO |
|--------|------|-----|
| AJo | UTG 以降でオープン | UTG は混合戦略（50〜80% 頻度）、CO 以降は高頻度オープン |
