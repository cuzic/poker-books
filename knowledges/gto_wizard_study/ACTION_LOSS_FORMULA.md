...
```
Step 1: eq_score = GridBase[カテゴリ][board] + w_dv × DV + w_oc × overcards
Step 2: action_score = w_tier × カテゴリ + eq_score + w_pot × pot - w_bs × bs + intercept
...
| (参考) カテゴリ+eq 旧式 (eq 真値) | 71.0% | 0.34 BB | 1.22% |
